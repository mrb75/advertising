...
class User(AbstractUser):
    ...
    date_banned = models.DateTimeField(null=True, blank=True)
    negetive_score = models.IntegerField(default=0)
    introducer = models.ForeignKey('self', models.CASCADE,
                                   null=True, blank=True, related_name='introducedUsers')
